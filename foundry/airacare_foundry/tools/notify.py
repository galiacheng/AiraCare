...
emergency); the edge acts autonomously on its own and never depends on the cloud. This
tool is where cloud-side delivery lives. In this scaffold it records actions instead of
sending them, so the flow is observable without external services (SMS/push/geofence come
later).
"""

from __future__ import annotations

from airacare_foundry.contracts import CloudAction
